Alias: $q4ms-repository-aenderungskategorie = https://pathway-fgdh.wiwi.tu-dresden.de/fhir/CodeSystem/Q4MSRepositoryAenderungskategorie
Alias: $q4ms-repository-aenderung-sd = https://pathway-fgdh.wiwi.tu-dresden.de/fhir/StructureDefinition/Q4MSRepositoryAenderungProfile
Alias: $q4ms-repository-aenderungsnachricht-sd = https://pathway-fgdh.wiwi.tu-dresden.de/fhir/StructureDefinition/Q4MSRepositoryAenderungnachrichtProfile
Alias: $q4ms-repository-aenderungsnachrichtkopf-sd = https://pathway-fgdh.wiwi.tu-dresden.de/fhir/StructureDefinition/Q4MSRepositoryAenderungsnachrichtkopfProfile
Alias: $q4ms-fhir-rest-api-endpoint-sd = https://pathway-fgdh.wiwi.tu-dresden.de/fhir/StructureDefinition/Q4MSFhirRestApiEndpointProfile
